...
public class CRUD {
    ...
    public static void update(String sql, Object... args) {
        ...
        try {
            connection = com.Database.JDBC.ConnectionUtil.getConnection();
            ...
            com.Database.JDBC.ConnectionUtil.closeConAndPS(connection, preparedStatement);
        }
    }
    ...
    public static void getInstance(String sql, Object args) {
        ...
        try {
            ...
            com.Database.JDBC.ConnectionUtil.closeConPSAndRS(connection, preparedStatement, resultSet);
        }
    }
